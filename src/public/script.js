...
async function carregarClientes() {
    ...
    try {
        ...
        mostrarMensagem('Erro ao carregar os clientes. Tente novamente.', 'erro');
    }
}
    ...
    clientes.forEach(cliente => {
        html += `
            <tr>
                ...
                <td class="acoes">
                    <button class="btn btn-edit" onclick="editarCliente(${cliente.idc}, '${cliente.nome}', '${cliente.cpf}', '${cliente.email}', '${cliente.telefone}')">✏️ Editar</button>
                    <button class="btn btn-danger" onclick="deletarCliente(${cliente.idc})">🗑️ Deletar</button>
                </td>
            </tr>
        `;
    });
...
async function buscarClientes(tipo, valor) {
    ...
    try {
        ...
        // 🔥 IMPORTANTE: busca por ID retorna objeto, não array
